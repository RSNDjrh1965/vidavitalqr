...
**Pendiente:** falta que el usuario suba el ZIP más reciente (que ya incluye este arreglo) y confirme en un celular real que ahora sí se escucha el sonido, aunque sea justo después del primer toque en la pantalla en vez de exactamente al abrir.
